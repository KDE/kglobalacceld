                                              ...
                                              uint inverseSetterFlags)
{
    ...
    const bool shouldRejectModifyExistingInverseActions = inverseSetterFlags & RejectModifyExistingInverseActions;
    ...
    if (existingInverseOfForward == backwardActionUnique && existingInverseOfBackward == forwardActionUnique) {
        ...
        return true;
    } else if (shouldRejectModifyExistingInverseActions && (!existingInverseOfForward.isEmpty() || !existingInverseOfBackward.isEmpty())) {
        qCWarning(KGLOBALACCELD) << "Inverse actions" << componentUnique << forwardActionUnique << backwardActionUnique
